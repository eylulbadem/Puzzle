...
string infix2prefix( const string exp ){
    ...
    return "Prefix form of " + exp + " is: " + prefix;
...
void evaluatePrefix( const string exp ){
    ...
    cout << "Result of " << exp << " is: " << stk.getTop() << endl;
    return;
}
...
string postfix2prefix( const string exp ){
    ...
    tempExp = postfix2infix( exp);
    finalExp = infix2prefix( tempExp);
